...
project = u'SuperGUI'
copyright = u'2015, Andrew Fowlie, Michael Bardsley'
author = u'Andrew Fowlie, Michael Bardsley'
...
latex_documents = [
  (master_doc, 'SuperGUI.tex', u'SuperGUI Documentation',
   u'Andrew Fowlie, Michael Bardsley', 'manual'),
]
...
man_pages = [
    (master_doc, 'supergui', u'SuperGUI Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'SuperGUI', u'SuperGUI Documentation',
   author, 'SuperGUI', 'One line description of project.',
   'Miscellaneous'),
]
...
# Disable decorators that interfere with docstrings

import superplot.statslib.mock_joblib as mock_joblib
sys.modules['superplot.statslib.patched_joblib'] = mock_joblib
